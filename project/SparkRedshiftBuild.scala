  ...
  lazy val root = Project("spark-redshift", file("."))
    ...
    .settings(
      ...
      libraryDependencies ++= Seq(
        ...
        "com.amazonaws" % "aws-java-sdk-core" % "1.10.61" % "provided" exclude("com.fasterxml.jackson.core", "jackson-databind"),
        "com.amazonaws" % "aws-java-sdk-s3" % "1.10.61" % "provided" exclude("com.fasterxml.jackson.core", "jackson-databind"),
        "com.amazonaws" % "aws-java-sdk-sts" % "1.10.61" % "test" exclude("com.fasterxml.jackson.core", "jackson-databind"),
